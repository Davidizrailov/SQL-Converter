...
Use python 3.11. Don't use javascript or SQL use python for the language. Make sure to properly deal with the keyword "OUT" as it is an unsupported data type. I have provided examples and documentation about scripting python in Snowflake can be found in the vector store
